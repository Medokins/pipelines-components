...
0. **Run status initialization**: Seeds ``.automl/run_status.json`` on the workspace and publishes an initial ``run_status`` artifact for dashboards before any data I/O.
